...
class GeolocationHelper: NSObject, WKScriptMessageHandler, CLLocationManagerDelegate {
    ...
    func setUserContentController(webViewConfiguration: WKWebViewConfiguration) {
        webViewConfiguration.userContentController.add(self, name: "listenerAdded")
        webViewConfiguration.userContentController.add(self, name: "listenerRemoved")
    }
